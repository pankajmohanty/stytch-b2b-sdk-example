import React, { useEffect, useState, useMemo, FormEventHandler, MouseEventHandler } from "react";
...
const IDPList = ({ saml_connections, oidc_connections }: { saml_connections: SAMLConnection[]; oidc_connections: OIDCConnection[] }) => {
